    ...
    <div class="main-banner">
      <div class="container">
        <div class="row justify-content-between align-items-center">
          <div class="banner-content">
            <h1 class="banner-title"><em>The</em> Music Competition App</h1>
            <h2>By MiV ...Music is Vivid</h2>
            <div class="download_apps_button">
              <a
                href="https://play.google.com/store/apps/details?id=com.techno.miv.miv&hl=en"
                target="_blank"
                class="store-button"
              >
              ...
              <a
                href="https://apps.apple.com/in/app/music-is-vivid/id1489035451"
                target="_blank"
                class="store-button"
              >
            ...
            <!-- <div class="clearfix">
                          <div class="btnRoundedBody d-block p-0 pt-4 text-right">
                            <button
      ...
      <div class="home_vote_section">
        <div class="container" style="margin-top: 80px">
          ...
          <h2 class="home-sub-heading">Great Video and Sound Quality</h2>
          <!-- <h3 class="noad-heading">
            <span>NO ADS</span>
          </h3>

          <div>
            <div class="clearfix">
              <div class="btnRoundedBody d-block p-0 pb-4 text-center">
                <button
                  class="btnRounded btnPurple"
                  type="button"
                  v-if="!user"
                  @click="$router.push('Fanregister')"
                >Sign up for more details</button>
              </div>
            </div>
          </div> -->
            ...
            <div class="howitworks_content">
              <div class="how-its-work-content-container">
                <div class="howitworks_content_each">
                  ...
                  <span class="text"
                    >Fans Are 100% in Charge; Vote in
                    Contests-Follow-Like-Love.</span
                  >
                </div>
                <div class="howitworks_content_each">
                  <span class="hexagon yellow-bg">2</span>
                  <span class="text"
                    >New Contest Every 30 minutes, 24 hours in each Genre.</span
                  >
                </div>
                <div class="howitworks_content_each">
                ...
                <div class="howitworks_content_each">
                  ...
                  <span class="text">
                    More for Fans; Discover new artist/music, Listen anytime,
                    Build Playlists, Share. Member- Rewards-Events-Special Fans.
                  </span>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="row align-items-center">
                ...
                <div class="membership_plan">
                  ...
                  <ul>
                    <li>
                      ...
                      <span>
                        Vote for Your Favorite Artist .. Only Members Vote..Your
                        100% in Charge
                      </span>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <span>
                        Only Members Vote, see results and get Leaderboard
                        access
                      </span>
                    </li>
                  </ul>
            ...
            <div class="col-md-6 col-lg-6 small-device-center">
              <span class="member_price"> <font>$3.99/</font>Month </span>
              <div class="pl-35">
                <span>Cancel anytime</span>
