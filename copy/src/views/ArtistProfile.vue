              ...
              <div class="profile-details-section">
                <div class="peofile-picture-section">
                  <div class="profile-picture">
                    <img
                      v-if="user.profilePicture== '' || user.profilePicture== null "
                      src="/assets/images/default_artist.png"
                      alt
                    >
                    <!-- <img v-else :src="allpath.profile_image_path+user.profilePicture" alt> -->
                    <div v-if="user.profilePicture" class="profile-image-view" v-bind:style="{ 'background-image': 'url(' + allpath.profile_image_path+user.profilePicture + ')' }"></div>
                  </div>
                    ...
                    <div class="top-section display-flex">
                      <div class="tab-nav-section">
                        <ul class="nav nav-tabs fan-profile-tab">
                          <li class="active">
                            <a data-toggle="pill" href="#playlist" class="active show">My Playlist</a>
                          </li>
                          <li>
                            <a data-toggle="pill" href="#new_releases" class>New Releases</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <div class="tab-content">
                        ...
                        <div id="new_releases" class="tab-pane fade">
                          <ul class="fan-new-releases-album-ul">
                            <li v-for="(eachAlbum,index) in newReleaseAlbumArr" :key="index">
                              <router-link
                                :to="{ name: 'ArtistAlbumdetails', params: { id: eachAlbum.id }}"
                              >
                                <img
                                  v-if="eachAlbum.coverImage=='' || eachAlbum.coverImage==null"
                                  src="assets/images/deefault_album.png"
                                >
                                <img v-else :src="allpath.album_pictures+eachAlbum.coverImage">
                              </router-link>
                            </li>
          ...
          <div class="modal-body">
            ...
            <div>
              ...
              <div class="text-center p-3">
                ...
                <button class="btn btn-dark" @click="closeCropper()">Cancel</button>
              </div>
            </div>
          </div>
        </div>
