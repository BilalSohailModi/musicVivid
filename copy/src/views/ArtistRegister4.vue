          ...
          <div class="artist-sign-up-wraper medium">
            <form action="signup_success_msg.html">
              <div class="ar-signup-heading-container" id="scrolldiv">
                ...
                <span v-if="ispromo" class="error-messages">Please insert promotional video</span>
                <span v-if="isintro" class="error-messages">Please insert introductional video</span>
              </div>
              <vue-dropzone
              ...
              >
                <div class="video-upload-container">
                  <ul class="video-upload-wraper">
                    ...
                    <li class="video-upload-btn-container">
                      ...
                      <p class="video-upload-btn-para">
                        Or
                        <button type="button" class="video-upload-btn btn-join">Upload an Video</button>
                  ...
                  <div class="video-upload-caption">
                    ...
                    maximum of 3 minutes and will be featured in as a
                    promotional video as well as digital events.
                  </div>
                </div>
              </vue-dropzone>
              <!-- <div class="video-upload-container">
...
export default {
  ...
  methods: {
    skippage(){
      ...
      API.put('skip-profile',null,config).then(response => {
