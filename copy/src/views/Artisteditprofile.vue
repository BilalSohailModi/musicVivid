                ...
                <div class="profile-right-section-edit">
                  <div class="row justify-content-center">
                    <div class="peofile-picture-section edit">
                      <div id="scrolldiv" class="profile-picture edit">
                        ...
                        <img
                          v-if="$store.state.registerdata2.profilePicture == null || $store.state.registerdata2.profilePicture == '' "
                        ...
                        <div
                          v-if="$store.state.registerdata2.profilePicture != null || 
                    $store.state.registerdata2.profilePicture != '' "
                      ...
                      <button
                        ...
                        v-if="!$store.state.registerdata2.profilePicture && profilepictur !== 1"
                      >
                  ...
                  <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10 col-md-12 custom-form">
                      ...
                      <div class="row">
                        <div class="form-group mb-3 col-lg-6 col-sm-6 edit-profile">
                          <label>Name</label>
                          <input
                            type="text"
                            class="form-control"
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-sm-12 d-flex">
                          <label class="swipe-button w-100">
                            Have You Played at Any Festivals Within The Last Year?
                            <input
                              type="checkbox"
                              @change="setsendData"
                              value="1"
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-sm-12 d-flex">
                          <label class="swipe-button w-100">
                            Do You Agree That Any Payments From MiV Are Only For The Artist Or Band And Not 3rd Party’s?
                            <input
                              type="checkbox"
                              @change="setsendData"
                              value="5"
                        ...
                        <div class="col-lg-12 col-sm-12 d-flex">
                          <label class="swipe-button w-100">
                            Are You The Originator And/Or Hold The Rights To Use The Music You Intend To Upload On MiV?
                            <input
                              type="checkbox"
                              @change="setsendData"
                              value="6"
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-sm-12">
                          <label class="swipe-button w-100">
                            Is The Copyright Holder For Music You Intend To Use On MiV Registered With BMI, ASCAP, SESAC, Merlin Or Any Other Private Firms?
                            <input
                              type="checkbox"
                              @change="setsendData"
                              value="7"
                        ...
                        <div class="col-lg-12 col-sm-12 d-flex">
                          <label class="swipe-button w-100">
                            Do You Agree Not To Use Any Music Owned And Managed By Any Of The Major Music Labels?
                            <input
                              type="checkbox"
                              @change="setsendData"
                              value="8"
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-sm-12 d-flex">
                          <label class="swipe-button w-100">
                            Do You Agree To The User Agreement For Music is Vivid (MiV) For Artists?
                            <input
                              type="checkbox"
                              value="9"
                              @change="setsendData"
...
export default {
  ...
  methods: {
    filesChange(name, files) {
      ...
      new ImageCompressor(files[0], {
        ...
        success(result) {
          ...
          API.post("update-profile-picture", formData, head2).then(response => {
            if (response.data) {
              that.isLoading = false;
              that.initializedata();
              that.$store.state.profilepicture = ALL_PATH.profile_image_path + response.data.data.profilePicture;
            }
          }).catch(error => {});
        },error(e) {
    ...
    deletevideo(id, key) {
      ...
      API.post("delete-file", { fileId: id }, head1).then(response => {
        this.isLoading = false;
        if (key == "intro") {
      ...
      this.$validator.validateAll().then(result => {
        if (result) {
          ...
          if (this.$store.state.registerdata2.answers[2] == "0") {
            ...
            API.post("update-profile", this.$store.state.registerdata2, head).then(response => {
              if (response.data) {
                this.isAgre1 = false;
                this.isAgre = false;
                this.isError = false;
