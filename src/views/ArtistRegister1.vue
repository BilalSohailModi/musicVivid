            ...
            >
              ...
              <div class="sign_unsign-div">
                <p style="margin-bottom: 1rem">
                  Are you signed with a major label
                </p>
                ...
                <span v-show="errors.has('Sign Unsign')" class="text-danger">{{
                  errors.first("Sign Unsign")
                }}</span>
              </div>
              ...
              >
                ...
                <div class="fild-icon-right">
                  ...
                  <span class="message" v-show="errors.has('Channel Name')">{{
              ...
              >
                ...
                <div
                  class="fild-icon-right"
                  v-show="errors.has('address') || !isCity"
                >
                  <i class="icon-warning"></i>
...
export default {
  ...
  methods: {
    ...
    getAddressData: function (addressData, placeResultData, id) {
      ...
      this.uploadForm.address = placeResultData.formatted_address;
      ...
      if (placeResultData && placeResultData.address_components) {
        ...
        this.uploadForm.city = placeResultData.address_components[0].long_name;
        this.uploadForm.state = placeResultData.address_components[1].long_name;
      }
    },
    loggletextare() {
    ...
    validateBeforeSubmit() {
      ...
      this.$validator.validateAll().then((result) => {
        if (result) {
          sessionStorage.setItem("onwatdata", JSON.stringify(this.uploadForm));
          this.sendBackend();
        }
      });
    },
  ...
  beforeRouteLeave(to, from, next) {
    ...
    if (to.path == "/artistregister") {
      swal({
        title: "Are you sure?",
        text:
          "By going back, for security reasons, you will need to Log Back In.",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      }).then((result) => {
