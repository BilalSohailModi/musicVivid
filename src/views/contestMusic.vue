  ...
  <div>
    ...
    <div class="live-contest-section">
      ...
      <div class="text-right p-3" v-if="songList.length < 3">
        <button class="dash-board-btn" @click="addSongView()">
          Add Song/Video
        </button>
      </div>
        ...
        <div class="col-md-8 upload-div m-5">
          ...
          <div class="p-5">
            ...
            <input
              ...
              class="form-control"
            />
            <div class="text-danger mt-1" v-if="isSongTitle">
          ...
          <div class="justify-content-center relativediv">
            <div class="col-md-12">
              <div class="text-danger2" v-if="typeError">
                Please Select A Mp3/Mp4 File
              </div>
              <div class="text-danger2" v-if="isuploaded">
              ...
              >
                <span class="music-icon">
                  <img
                    :src="
                      file.type == 'audio/mp3'
                        ? '/assets/images/music-file.png'
                        : '/assets/images/video-file.png'
                    "
                    width="30"
                    alt
                  />
            ...
            >
              ...
              <div class="progress-bar">
                <span class="progress-bar-details">
                  <span
                    class="fill-value"
                    v-bind:style="{ width: this.widthValue + '%' }"
                    >{{ widthValue }}%</span
                  >
                </span>
              </div>
      ...
      <div class="col-md-10 m-auto border-cls">
        <div class="track-row-container">
          ...
          <div class="text-center" v-if="errorMsg">
                ...
                <div class="track-icon-box">
                  ...
                  <label class="track-play-btn">
                    ...
                    >
                      <img
                        :src="
                          song.mimeType == 'video/mp4'
                            ? '/assets/images/video-camera.png'
                            : '/assets/images/track-leaf.png'
                        "
                        :id="'image' + song.id"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="clearfix text-center">
              <button class="modal-back-btn m-2" @click="confirmDelete()">
                Confirm
              </button>
              <button class="m-2 modal-back-btn" data-dismiss="modal">
                Cancel
              </button>
            </div>
          </div>
...
export default {
  ...
  methods: {
        ...
        .then((response) => {
          if (response.data) {
            ...
            localStorage.setItem(
              "contestMusicCount",
              JSON.stringify(contestMusicValue)
            );
            ...
            console.log(
              "contest music list",
              JSON.parse(JSON.stringify(this.songsIdArr))
            );
          }
        })
        .catch((error) => {});
    ...
    onEnd(e) {
      ...
      if (
        JSON.stringify(this.songsIdArr) != JSON.stringify(updatedPriorityId)
      ) {
        let head2 = {
          headers: {
            "x-access-token": JSON.parse(localStorage.getItem("Token")),
    ...
    saveUploadedFile() {
      ...
      API.post("contest-music", formData, head2)
        .then((response) => {
          this.widthValue = 100;
          setTimeout(() => {
            if (response.data) {
