      ...
      <div class="container">
        <div class="row">
          <div class="artist-sign-up-wraper medium">
            <form
              action="artist-sign-up-step-3.html"
            ...
            >
              ...
              <div class="question-container">
                <h3 class="question-field">
                  Do You Agree That Any Payments From MiV Are Only For The
                  Artist Or Band And Not 3rd Party’s?
                </h3>
                <div class="answer-field">
                  <div class="switch-container">
                    <label class="switch">
              ...
              <div class="question-container">
                <h3 class="question-field">
                  Are You The Originator And/Or Hold The Rights To Use The Music
                  You Intend To Upload On MiV?
                </h3>
                <div class="answer-field">
                  <div class="switch-container">
                    <label class="switch">
              ...
              <div class="question-container">
                <h3 class="question-field">
                  Is The Copyright Holder For Music You Intend To Use On MiV
                  Registered With BMI, ASCAP, SESAC, Merlin Or Any Other Private
                  Firms?
                </h3>
                <div class="answer-field">
                  <div class="switch-container">
                    <label class="switch">
                      <input type="checkbox" v-model="rgisterdata.answers[6]" />
                      <span class="slider round"></span>
                    </label>
                  </div>
                  <textarea
                    ...
                    style="display: block"
                  ></textarea>
                  <span v-show="errors.has('answer')" class="text-danger1">{{
                    errors.first("answer")
                  }}</span>
                </div>
              </div>
              <div class="question-container">
                <h3 class="question-field">
                  Do You Agree Not To Use Any Music Owned And Managed By Any Of
              ...
              <div class="social-following-section">
                <label class="label-heading"
                  >Combined Social Media Followings</label
                >
                ...
                <span
                  ...
                  class="text-danger"
                  >Must choose a Social Media Followings
                </span>
              </div>
              <button
